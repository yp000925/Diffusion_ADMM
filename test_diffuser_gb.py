...
import numpy as np
from utils.functions import generate_otf_torch, psnr,norm_tensor, crop_img_torch,zero_padding_torch
...
A = solver.A
AT = solver.AT
opts = dict(rho=torch.tensor([3]), maxitr=15, verbose=True, gt=torch.tensor(gt_intensity), eta=0.9,
