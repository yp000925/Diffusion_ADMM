...
class pnp_ADMM_DH():
    ...
    def inverse_step(self, v, u, y, rho, o_old):
        ...
        return o_next.abs(), mse_loss(o_old, o_next.abs())
    ...
    def denoise_step(self, o, u, denoiser, v_old):
        ...
        return v_next.squeeze(0), mse_loss(v_old, v_next.squeeze(0))
    ...
    def pnp_Admm_DH(self, y, opts):
        ...
        for i in pbar:
            ...
            if verbose:
                ...
                writer.add_scalar('o_update', e1)
                writer.add_scalar('v_update', e2)
                writer.add_scalar('u_update', e3)
                writer.add_scalar('rho', self.rho)
                writer.add_scalar('gamma', self.gamma)
                writer.add_scalar('eta', self.eta)
                writer.add_scalar('PSNR',psnr(v, gt))
