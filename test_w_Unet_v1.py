...
from pnp_admm_Unet1c_V1 import pnp_ADMM_DH
from utils import *
...
# ---- set solver -----
solver = pnp_ADMM_DH(w, nx, ny, deltax, deltay, distance, model, device=device, visual_check=20)
A = solver.A
AT = solver.AT
opts = dict(rho=torch.tensor([0.01]), maxitr=300, verbose=True, gt=torch.tensor(gt_intensity), eta=0.9,
            tol=0.0000001, gamma=1, psnr_tol=0, patient=100, mu=0.001)
