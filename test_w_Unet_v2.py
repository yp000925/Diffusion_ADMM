...
# ---- set solver -----
solver = pnp_ADMM_DH(w, nx, ny, deltax, deltay, distance, model, device=device, visual_check=1)
A = solver.A
AT = solver.AT
opts = dict(rho=torch.tensor([0.05]), maxitr=10, verbose=True, gt=torch.tensor(gt_intensity), eta=0.9,
